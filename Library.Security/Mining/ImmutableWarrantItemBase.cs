...
{
    [DataContract(Name = "WarrantItemBase", Namespace = "http://Library/Security")]
    public abstract class ImmutableWarrantItemBase<T> : ImmutableCertificateItemBase<T>, ICash
        where T : ImmutableWarrantItemBase<T>
    {
