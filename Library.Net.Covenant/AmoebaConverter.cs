...
namespace Library.Net.Covenant
{
    public static class CovenantConverter
    {
        ...
        public static string ToSeedString(Seed item)
        {
            ...
            try
            {
                using (Stream stream = CovenantConverter.ToStream<Seed>(item))
                {
                    return "Seed:" + CovenantConverter.ToBase64String(stream);
                }
            }
            catch (Exception)
            {
        ...
        public static Seed FromSeedString(string item)
        {
            ...
            try
            {
                using (Stream stream = CovenantConverter.FromBase64String(item.Remove(0, "Seed:".Length)))
                {
                    return CovenantConverter.FromStream<Seed>(stream);
                }
            }
            catch (Exception)
            {
        ...
        public static Stream ToBoxStream(Box item)
        {
            ...
            try
            {
                return CovenantConverter.ToStream<Box>(item);
            }
            catch (Exception)
            {
                throw new FormatException();
        ...
        public static Box FromBoxStream(Stream stream)
        {
            ...
            try
            {
                return CovenantConverter.FromStream<Box>(stream);
            }
            catch (Exception)
            {
                throw new FormatException();
