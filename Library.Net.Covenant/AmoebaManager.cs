...
namespace Library.Net.Covenant
{
    ...
    public sealed class CovenantManager : StateManagerBase, Library.Configuration.ISettings, IThisLock
    {
        ...
        public CovenantManager(string bitmapPath, string cachePath, BufferManager bufferManager)
        {
        ...
        public Information Information
        {
            get
            {
                ...
                if (!_isLoaded) throw new CovenantManagerException("CovenantManager is not loaded.");
        ...
        public void Load(string directoryPath)
        {
            ...
            lock (this.ThisLock)
            {
                if (_isLoaded) throw new CovenantManagerException("CovenantManager was already loaded.");
                _isLoaded = true;
    ...
    [Serializable]
    class CovenantManagerException : StateManagerException
    {
        public CovenantManagerException() : base() { }
        public CovenantManagerException(string message) : base(message) { }
        public CovenantManagerException(string message, Exception innerException) : base(message, innerException) { }
    }
}
